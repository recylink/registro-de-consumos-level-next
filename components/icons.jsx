// Set de iconos SVG inline, estilo Feather, en un viewBox de 24x24.
// Portado tal cual desde proto/icons.jsx — sin dependencia de fuente de iconos.
...
export const ICON_PATHS = {
  ...
  eye_off:       <g><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></g>,
};

/**
 * Icono por nombre. `fill` lo pinta relleno en vez de solo trazo; `color`
 * sobreescribe el currentColor heredado.
 */
export function Icon({ name, size = 18, fill, color, style, strokeWidth = 2 }) {
  const path = ICON_PATHS[name];
  if (!path) {
    // Cuadrado punteado para que un icono faltante se note en desarrollo.
    return (
      <span
        style={{ display: "inline-block", width: size, height: size, border: "1px dashed #ccc", ...style }}
        title={"icono inexistente: " + name}
      />
    );
  }
  return (
