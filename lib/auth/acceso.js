 ...
 *
 * No reemplaza al subdominio. Safari y Firefox bloquean las cookies de terceros por
 * defecto, así que con esto puede seguir sin entrar en iPhone. Servir la app desde un
 * subdominio del sitio que la embebe hace que deje de ser "de terceros" y entonces el
 * `lax` de siempre alcanza, sin esta variable.
 */
