 ...
 */
export async function completeFoto({ rowIndex, fotoRow, patch, completedAt = new Date().toISOString() }) {
  if (!rowIndex) throw new Error("Falta rowIndex de la fila de la foto");
  const f = fotoRow || {};
