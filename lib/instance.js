...
// Instancia del cliente Level (espejo de la versión Apps Script que corre en
// registro-de-consumos-level). El valor viaja en la columna "Empresa" de cada fila,
// y las filas que ya están en la planilla dicen "Level": cambiarlo parte el historial
// en dos sin dar ningún error.
export const EMPRESA = "Level";
...
export function hayBackend() {
  return appsScriptConfigurado() || isSdkConfigured();
}
