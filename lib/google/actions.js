 ...
 *
 * NO lo llama nada de la app: se invoca por curl al provisionar (ver ARQUITECTURA.md).
 * Por eso la respuesta conserva la forma del original, que es para leer.
 */
...
//
// Los bloques E (upload, move, deleteFile) y G (init, setup) están completos.
//
